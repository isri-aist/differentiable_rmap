...
*/
template<class T>
std::string vecToStr(const T & vec, const std::string delim = ", ")
{
  std::string str = "";
...
{
template<class DivideIdxsType, class DivideNumsType>
int calcGridIdx(const DivideIdxsType & divide_idxs, const DivideNumsType & divide_nums)
{
  int grid_idx = 0;
  int stride = 1;
                            ...
                            const DivideNumsType & divide_nums)
{
  ...
  {
    divide_idxs[i] =
        std::min(std::max(static_cast<int>(std::round(divide_ratios[i] * divide_nums[i])), 0), divide_nums[i]);
  }
}
...
template<>
inline Sample<SamplingSpace::SO3> gridPosToSample<SamplingSpace::SO3>(const GridPos<SamplingSpace::SO3> & grid_pos)
{
  Sample<SamplingSpace::SO3> sample;
  sample << Eigen::Quaterniond(Eigen::AngleAxisd(grid_pos.x(), Eigen::Vector3d::UnitX())
                               * Eigen::AngleAxisd(grid_pos.y(), Eigen::Vector3d::UnitY())
                               * Eigen::AngleAxisd(grid_pos.z(), Eigen::Vector3d::UnitZ()))
                .coeffs();
  return sample;
}

template<>
inline Sample<SamplingSpace::SE3> gridPosToSample<SamplingSpace::SE3>(const GridPos<SamplingSpace::SE3> & grid_pos)
{
  Sample<SamplingSpace::SE3> sample;
  sample << grid_pos.head<3>(),
      Eigen::Quaterniond(Eigen::AngleAxisd(grid_pos.tail<3>().x(), Eigen::Vector3d::UnitX())
                         * Eigen::AngleAxisd(grid_pos.tail<3>().y(), Eigen::Vector3d::UnitY())
                         * Eigen::AngleAxisd(grid_pos.tail<3>().z(), Eigen::Vector3d::UnitZ()))
          .coeffs();
  return sample;
}
...
template<>
inline GridPos<SamplingSpace::SO3> sampleToGridPos<SamplingSpace::SO3>(const Sample<SamplingSpace::SO3> & sample)
{
...
template<>
inline GridPos<SamplingSpace::SE3> sampleToGridPos<SamplingSpace::SE3>(const Sample<SamplingSpace::SE3> & sample)
{
  GridPos<SamplingSpace::SE3> grid_pos;
  grid_pos << sampleToGridPos<SamplingSpace::R3>(sample.head<3>()),
      sampleToGridPos<SamplingSpace::SO3>(sample.tail<4>());
  return grid_pos;
}
...
template<>
inline GridPos<SamplingSpace::SO3> getGridPosMin<SamplingSpace::SO3>(const Sample<SamplingSpace::SO3> & sample_min)
{
...
template<>
inline GridPos<SamplingSpace::SE3> getGridPosMin<SamplingSpace::SE3>(const Sample<SamplingSpace::SE3> & sample_min)
{
  GridPos<SamplingSpace::SE3> grid_pos_min;
  grid_pos_min << getGridPosMin<SamplingSpace::R3>(sample_min.head<3>()),
      getGridPosMin<SamplingSpace::SO3>(sample_min.tail<4>());
  return grid_pos_min;
}
...
template<>
inline GridPos<SamplingSpace::SO3> getGridPosMax<SamplingSpace::SO3>(const Sample<SamplingSpace::SO3> & sample_max)
{
...
template<>
inline GridPos<SamplingSpace::SE3> getGridPosMax<SamplingSpace::SE3>(const Sample<SamplingSpace::SE3> & sample_max)
{
  GridPos<SamplingSpace::SE3> grid_pos_max;
  grid_pos_max << getGridPosMax<SamplingSpace::R3>(sample_max.head<3>()),
      getGridPosMax<SamplingSpace::SO3>(sample_max.tail<4>());
  return grid_pos_max;
}
...
template<>
inline GridPos<SamplingSpace::SO3> getGridPosRange<SamplingSpace::SO3>(const Sample<SamplingSpace::SO3> & sample_min,
...
template<>
inline GridPos<SamplingSpace::SE3> getGridPosRange<SamplingSpace::SE3>(const Sample<SamplingSpace::SE3> & sample_min,
                                                                       const Sample<SamplingSpace::SE3> & sample_max)
{
  GridPos<SamplingSpace::SE3> grid_pos_range;
  grid_pos_range << getGridPosRange<SamplingSpace::R3>(sample_min.head<3>(), sample_max.head<3>()),
...
void loopGrid(const DivideNumsType & divide_nums,
              ...
              const GridIdxs<SamplingSpaceType> & default_divide_idxs)
{
      ...
      if(std::find(update_dims.begin(), update_dims.end(), i) == update_dims.end())
      {
        if(default_divide_idxs[i] < 0 || default_divide_idxs[i] > divide_nums[i])
        {
          mc_rtc::log::error_and_throw<std::runtime_error>(
              "[loopGrid] default_divide_idxs[{}] is invalid. It should be 0 <= {} <= {}", i, default_divide_idxs[i],
              divide_nums[i]);
        }
  ...
  do
  {
    ...
    func(calcGridIdx(divide_idxs, divide_nums), divide_ratios.cwiseProduct(grid_pos_range) + grid_pos_min);
...
template<SamplingSpace SamplingSpaceType, class DivideNumsType>
Eigen::Vector3d calcGridCubeScale(const DivideNumsType & divide_nums,
